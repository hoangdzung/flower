...
from .utils import ClientDataset, get_model, get_transforms, test, train


class RayClient(fl.client.NumPyClient):
    """Ray Virtual Client."""

    def __init__(self, cid: str, fed_dir: Path, num_classes: int, num_channels: int):
...
def get_ray_client_fn(
    fed_dir: Path, num_classes: int = 10, num_channels: int = 3
    ...
    def client_fn(cid: str) -> RayClient:
        ...
        return RayClient(cid=cid, fed_dir=fed_dir, num_classes=num_classes, num_channels=num_channels)
